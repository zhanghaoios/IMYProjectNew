...
#import "ZonePagerViewController.h"
...
- (void)addNewsController
{
    ...
    ViewController *newsPagerController = [[ViewController alloc]init];
...
- (void)addRecommendController
{
    ...
    LoginViewController *recommendController = [[LoginViewController alloc]init];
...
- (void)addZoneController
{
    ...
    ZonePagerViewController *zoneController = [[ZonePagerViewController alloc]init];
...
- (void)addMineController
{
    ...
    NewsPagerViewController *mineController = [[NewsPagerViewController alloc]init];
